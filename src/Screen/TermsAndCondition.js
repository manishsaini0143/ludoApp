    ...
    return (
        <View style={{ backgroundColor: '#711e21', flex: 1 }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', padding: 10 }}>
                ...
                <Text style={{ color: '#FFFFFF', fontSize: 20, fontWeight: 'bold' }}>Terms and Condition</Text>
            ...
            <ScrollView contentContainerStyle={{ paddingBottom: 40 }}>
                ...
                <View style={{ alignItems: 'center' }}>
                    <Text style={{ color: '#FFFFFF', fontSize: 20, fontWeight: 'bold', margin: 5 }}>terms and condition</Text>
