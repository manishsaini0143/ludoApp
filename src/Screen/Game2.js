    ...
    const renderItem1 = ({ item, }) => (
        ...
        <View style={{ width: '90%', alignSelf: 'center', borderWidth: 1, borderColor: '#417EAD', borderRadius: 15, margin: 5 }}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', padding: 10 }}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('Supercoin')} style={{ backgroundColor: 'yellow', width: 65, justifyContent: 'center', alignItems: 'center', height: 30, borderRadius: 10 }}>
