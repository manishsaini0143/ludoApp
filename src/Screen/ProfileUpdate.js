        ...
        <View style={{ backgroundColor: '#2b090a', flex: 1 }}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: '90%', alignSelf: 'center', margin: 10 }}>
                ...
                <TouchableOpacity onPress={openModal} style={{ backgroundColor: 'blue', width: 95, alignSelf: 'center', borderRadius: 10, height: 40, borderWidth: 1, borderColor: '#FFFFFF', justifyContent: 'center' }} >
                    <Text style={{ textAlign: 'center', fontSize: 18, color: '#FFFFFF', fontWeight: 'bold' }}>
                        UPLOAD
                    </Text>
                </TouchableOpacity>
                <Modal
            ...
            <View style={{ marginTop: 20 }}>
                <View style={{ borderRadius: 10, backgroundColor: '#FFFFFF', width: '90%', flexDirection: 'row', height: 50, alignSelf: 'center', margin: 10 }} >
                    <TextInput style={{ color: '#000000', width: '90%', fontSize: 16, letterSpacing: 2, fontWeight: 'bold', left: 5 }} keyboardType='name-type' placeholder='User Name' placeholderTextColor='#B3B1B1' />
                </View>
                <View style={{ borderRadius: 10, backgroundColor: '#FFFFFF', width: '90%', flexDirection: 'row', height: 50, alignSelf: 'center', margin: 10 }} >
                    <TextInput style={{ color: '#000000', width: '90%', fontSize: 16, letterSpacing: 2, fontWeight: 'bold', left: 5 }} keyboardType='name-type' placeholder='State' placeholderTextColor='#B3B1B1' />
                </View>
                <View style={{ borderRadius: 10, backgroundColor: '#FFFFFF', width: '90%', flexDirection: 'row', height: 50, alignSelf: 'center', margin: 10 }} >
                    <TextInput style={{ color: '#000000', width: '90%', fontSize: 16, letterSpacing: 2, fontWeight: 'bold', left: 5 }} keyboardType='name-type' placeholder='Country' placeholderTextColor='#B3B1B1' />
                </View>
            </View>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: '90%', alignSelf: 'center', margin: 10 }}>
                <View>
                    <Text style={{ color: '#FFFFFF', fontSize: 20, left: 15, top: 7 }}>Gender</Text>
                    <RadioForm formHorizontal={true} animation={true}>
                        <RadioButton style={{ margin: 15 }} labelHorizontal={true}>
                            ...
                            <RadioButtonLabel
                                obj={{ label: 'Female', value: 'female' }}
                                index={0}
                                labelStyle={{ fontSize: 20, color: '#FFFFFF', left: 10, }}
                                onPress={() => setGender('female')}
                            />
                        </RadioButton>
                        <RadioButton style={{ margin: 15 }} labelHorizontal={true}>
