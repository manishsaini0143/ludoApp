    ...
    return (
        <View style={{ backgroundColor: '#2b090a', flex: 1 }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', padding: 10 }}>
                ...
                <Text style={{ color: '#FFFFFF', fontSize: 20,fontFamily:'JosefinSans-Bold' }}>Update Aadhar</Text>
            ...
            <View>
                <View style={{ alignItems: 'center', marginTop: 50 }}>
                    <Text style={{ color: '#FFFFFF', fontSize: 13, fontFamily:'Poppins-Bold' }}>Please provide your Aadhar number.</Text>
                    <Text style={{ color: '#FFFFFF', fontSize: 13,fontFamily:'Poppins-Bold' }}>We will send an OTP on the mobile number that is linked</Text>
                    <Text style={{ color: '#FFFFFF', fontSize: 13,fontFamily:'Poppins-Bold' }}>with Aadhar Card.</Text>
                </View>
                <View style={{ backgroundColor: '#FFFFFF', width: '85%', alignSelf: 'center', borderRadius: 10, marginTop: 20 }}>
                    <TextInput
                        maxLength={12}
                        style={{ left: 10, width: '75%', fontSize: 20, letterSpacing:2,fontFamily:'JosefinSans-Bold',}}
                ...
                {otpInputVisible ? (
                    <View style={{ marginTop: 20 }}>
                        <View style={{ width: '100%', alignItems: 'center', alignSelf: 'center' }}>
                            <Text style={{ color: '#FFFFFF', fontSize: 12,fontFamily:'Poppins-Bold'  }}>We have sent OTP on the mobile number linked with Aadhar.</Text>
                            <Text style={{ color: '#FFFFFF', fontSize: 11,fontFamily:'Poppins-Bold'  }}>Please provide OTP to verify Aadhar..</Text>
                ...
                >
                    <Text style={{ color: '#FFFFFF', fontSize: 22,fontFamily:'JosefinSans-Bold',bottom:2 }}>
